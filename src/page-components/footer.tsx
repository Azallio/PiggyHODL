        ...
        <>
            <footer className="w-360 h-5 flex justify-between px-43.75 mr-[3%]  mb-4 text-[#A4A4A4] hankenGrotesk font-semibold uppercase">
                ...
                <section className="flex w-73.75 gap-16 items-center">
                    <a href="https://telegram.org/tos/mini-apps" className="w-27.5 h-5 text-[16px] leading-5 tracking-normal hover:opacity-[50%] hover:border-b duration-150 ">
                        Terms of use
                    </a>
                    <a href="https://telegram.org/tos/mini-apps" className="w-30.25 h-5 text-[16px] leading-5 tracking-normal hover:opacity-[50%] hover:border-b duration-150">
                        Privacy policy
                    </a>
                </section>
            </footer>
