      ...
      <main className="w-360 h-168.5 px-43.75 py-3.75 gap-6 mr-[3.5%] tracking-normal">
        <section className="w-133.25 h-158.5 flex flex-nowrap gap-6 ">
          <article>
            ...
            <div className="w-133.25 h-141 flex flex-col gap-3 mt-5 overflow-scroll">
          ...
          <article className="w-133.25 h-158.5 flex flex-col gap-4 justify-around shrink-0">
            ...
            <div className="w-133.25 h-47.5 flex flex-col flex-wrap overflow-hidden gap-8 rounded-3xl p-6 bgcPink">
              ...
              <Link className=" w-45 h-12.5 flex justify-center shrink-0 font-semibold leading-4.5 tracking-[1%] uppercase text-black py-4 px-8 rounded-[40px] bgcDarkPink hankenGrotesk"
                to="tg://resolve?domain=test_piggygame_bot">
                Subscribe
              </Link>
            ...
            <div className="w-133.25 h-50.5 flex pr-6 gap-6 rounded-3xl bg-[#FFBFFB33] ">
              ...
              <div className="w-78 h-50.5 flex flex-col items-center py-6 gap-12">
                <p className="w-64.5 h-12 sourseSerif4 font-medium italic text-5xl leading-12 items-center cDarkPink">Join the game</p>
                <button className="w-53.25 h-14.5 px-10 py-5 gap-1 rounded-[40px] bgcDarkPink hankenGrotesk font-semibold text-[16px] leading-4.5 tracking-[1%] uppercase text-[#0D0D0D]">Play piggygame</button>
              </div>
            </div>
          </article>
        </section>
